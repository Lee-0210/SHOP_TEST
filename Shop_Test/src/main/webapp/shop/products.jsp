			...
			<div class="col-md-6 col-xl-4 col-xxl-3">
				<div class="card p-3">
					...
					<div class="content">
						...
						<p class="d-flex justify-content-between">
							<a href="./cart_pro.jsp?id=P100004"
								class="btn btn-outline-primary"><i
								class="material-symbols-outlined">shopping_bag</i></a> <a
								href="./product.jsp?id=P100004" class="btn btn-outline-primary">상세
								정보</a>
						</p>
					</div>
				</div>
			...
			<div class="col-md-6 col-xl-4 col-xxl-3">
				<div class="card p-3">
					...
					<div class="content">
						...
						<p class="d-flex justify-content-between">
							<a href="./cart_pro.jsp?id=P123123"
								class="btn btn-outline-primary"><i
								class="material-symbols-outlined">shopping_bag</i></a> <a
								href="./product.jsp?id=P123123" class="btn btn-outline-primary">상세
								정보</a>
						</p>
					</div>
				</div>
